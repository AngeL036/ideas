    ...
    import { abrirCaja, getCajaActiva, cerrarCaja} from "../../api/caja.api"
    ...
    import CerrarCajaModal from "../../components/puntoVenta/CerrarCajaModal"
    ...
    export default function PuntoVenta() {
        ...
        const handleCerrarCajaConfir = async () => {
            try{
                await cerrarCaja({monto_final: totalCarrito})
            }
            catch {
                setCajaError("No se pudo cerrar la caja. Intenta de nuevo.")
            }
            finally {
                setCerrarCajaModal(false)
        ...
        return (
            ...
            <CerrarCajaModal 
                ...
                onConfirm={handleCerrarCajaConfir}
            />
